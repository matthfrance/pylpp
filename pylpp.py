...
class LPPDatabase:
    ...
    def __init__(self, dbf_filepath):
    ...
    def populate_online(self, thread_count=30, batch_size=300):
        ...
        threads = [executor.submit(populate_lpp_item_online, group) for group in LPPDatabase._splitlist(self._database, batch_size)]
        concurrent.futures.wait(threads)
        self._database = [ lpp_record for thread in threads for lpp_record in thread.result() ]

    def write_CSV(self, output_lppcsvfile):
